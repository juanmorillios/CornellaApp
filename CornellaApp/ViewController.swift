...
class ViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    var place = Place(name: "Can Mercader", type: "Parque", location: "08940 Cornellà de Llobregat Barcelona, España", image: #imageLiteral(resourceName: "canmercader"), telephone: "3467894", webSite: "www.website.com")
    places.append(place)
